...
|2|Flow Chart (순서도)|[Click me](./docs/02_flowchart.md)|Flowchart 동영상|
|3|Sequence Diagram (순차도)|[Click me](./intro.md)|Sequence diagram 동영상|
|4|Class Diagram (클래스도)|[Click me](./docs/03_sequence_diagram.md)|Class diagram 동영상|
|5|ER Diagram (객체관계도)|[Click me](./docs/05_er_diagram_practice.md)|ER Diagram 동영상|
